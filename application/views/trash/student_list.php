			...
			<div class="row">
				...
				<div class="col-12">
					<div class="card-box table-responsive">
						<h3 class="m-t-0 header-title font text-center"> کامیاب طالباہ کی فہرست
						</h3>
						<table id="datatable" class="table">
							...
							<tr>
								...
								<td class="text-center"><a href="<?= site_url("applicant/student_registration/$st->id") ?>" class="btn btn-success"> <i class="fa fa-location-arrow"></i> داخلہ فارم </a> </td>
