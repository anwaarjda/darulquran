...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-left">
                ...
                <li><a href="<?= site_url('Accounts/checkBalance'); ?>"><i class="fa fa-check"></i> بیلنس چیک کریں</a>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a href="<?= site_url('Accounts/Ledger/Consolidated_Ledger');?>">
								<i style="margin-left: 80%; margin-top: 7%;" class="fa fa-arrow-circle-left" aria-hidden="true"><span style="font-family: 'Noto Nastaliq Urdu'">&nbsp;&nbsp;&nbsp;مشترکہ لیجر</span></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('Accounts/TrialBalance_new/getConsolidatedTrailBalance');?>">
								<i style="margin-left: 80%; margin-top: 7%;" class="fa fa-arrow-circle-left" aria-hidden="true"><span style="font-family: 'Noto Nastaliq Urdu'">&nbsp;&nbsp;&nbsp;مشترکہ ٹرایل بیلنس</span></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('Accounts/BalanceSheet/getConsolidatedBalanceSheet');?>">
								<i style="margin-left: 80%; margin-top: 7%;" class="fa fa-arrow-circle-left" aria-hidden="true"><span style="font-family: 'Noto Nastaliq Urdu'">&nbsp;&nbsp;&nbsp;مشترکہ بیلنس شیٹ</span></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('Accounts/IncomeStatment/getConsolidatedIncomeStatement')?>">
								<i style="margin-left: 80%; margin-top: 7%;" class="fa fa-arrow-circle-left" aria-hidden="true"><span style="font-family: 'Noto Nastaliq Urdu'">&nbsp;&nbsp;&nbsp;مشترکہ آمدنی کا گوشوارہ</span></i>
                            </a>
                        </li>
                    </ul>
                </li>
